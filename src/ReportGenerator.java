...
public class ReportGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("L2转出L3的Ticket数量:" + tickets.stream().filter(ticket -> ticket.SubmitterLevel == 2 && isNotEmpty(ticket.getRtcLink())).count());
    ...
    public static class RemedyTicket {
        ...
        public String toString() {
            return "RemedyTicket [ticketId=" + ticketId + ", label=" + label + ", servity=" + servity + ", initTime=" + initTime + ", reportTime=" + reportTime + ", resloveTime=" + resloveTime + ", submitTime=" + submitTime + ", service=" + service + "]";
        }
